...
var script = {
  ...
  methods: {
    setState: function setState() {
      this.state = this.next === '' || this.next === 0 ? this.head == null ? 'empty' : 'end' : 'standby';
    },
